...
export default function Events(){
    return(
        ...
        height={100}
        width={100}
         className="w-full h-[300px] md:h-[500px] object-cover brightness-50"/>

         <div className="absolute inset-0 flex flex-col items-center justify-center">
          <h1 className="text-white text-2xl md:text-3xl font-bold">Our Events</h1>
          <h1 className="text-white text-sm md:text-xl font-extrabold px-5 text-center">
            Explore upcoming and past events hosted by our community.
          </h1>
        </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10 mt-10 px-5 md:px-10 lg:px-20">
