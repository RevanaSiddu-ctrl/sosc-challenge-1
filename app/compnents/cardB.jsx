export default function CardB({ image, title, location, date }) {
  return (
    <div className="flex flex-col md:flex-row w-full h-auto md:h-[200px] bg-white rounded-xl shadow-md overflow-hidden cursor-pointer">
      ...
      <div className="w-full md:w-[60%] p-4 md:p-5 flex flex-col justify-between">
        ...
        <div>
          ...
          <p className="text-gray-700 text-xs md:text-sm mt-2">{location}</p>
        </div>

        <p className="text-gray-500 text-xs md:text-sm mt-2 md:mt-0">{date}</p>
      </div>
