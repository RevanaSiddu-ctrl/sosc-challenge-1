export default function CardA({ title, date, image, author }) {
  return (
    <>
      <div className="md:h-[200px] w-[350px] bg-white flex flex-col justify-center shadow-md shadow-black/40 rounded-md">
        <img
          src={image}
          alt="img"
          className="md:h-[45%] w-full object-cover rounded-t-md"
        />
