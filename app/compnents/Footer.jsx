...
export default function Footer(){
    return(
        <>
            <div className="bg-[oklch(77.034%_0.20078_152.412)] w-screen h-fit flex flex-row mt-10">
                ...
                <div className="h-[90%] flex flex-col md:flex-row mt-10">
                    ...
                    <div className="flex flex-col justify-start  gap-2 mt-5 w-full px-5">
                        ...
                        <h4 className="text-white/90 text-sm">Sahyadri College of Engineering and Management, Adyar, Mangalore - 575007 IN</h4>
                    ...
                    <div className="flex flex-col justify-center items-center w-[140px] gap-5 ml-20">
