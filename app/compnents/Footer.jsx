...
export default function Footer() {
  return (
    <>
      <div className="bg-[oklch(77.034%_0.20078_152.412)] w-full  h-[500px] md:h-[400px] flex flex-row mt-10">
        <div className="h-full md:h-[90%] gap-15 flex flex-col md:flex-row">
          <div className="flex flex-col mt-10 md:mt-0   justify-center  gap-2 ml-10 w-full ">
            <h2 className="text-white text-xl md:text-2xl text-bold ">
              Sahyadri Open Source Community
            </h2>
            <h4 className="text-white text-md mt-2 max-w-[300px] md:max-w-none">
          ...
          <div className="flex flex-row">
            <div className="flex flex-col justify-center text-white items-center w-full md:w-[140px] gap-2 ml-0 md:ml-40">
            ...
            <div className="flex flex-col justify-center items-center text-white w-full md:w-[300px] gap-2 ml-5 md:ml-20">
