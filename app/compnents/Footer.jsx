    ...
    <>
      <div className="bg-[oklch(77.034%_0.20078_152.412)] flex w-screen h-fit flex-col items-center mt-10">
        <div className="h-[90%] flex flex-col md:flex-row mt-10">
          ...
          <div className="flex flex-row mt-10 md:mt-0 px-5 justify-between">
            <div className="flex flex-col justify-start w-[140px] gap-5 md:ml-90 text-xs">
        ...
        <h3 className="text-xs mt-5 mb-5">SOSC © 2025 All Rights Reserved.</h3>
      </div>
    </>
  );
}
