...
export default function Footer() {
  return (
    <>
      <div className="bg-[oklch(77.034%_0.20078_152.412)] pb-6">
        <div className=" w-full h-[400px] flex mt-10 ">
          ...
          <div className="h-[90%] flex felx-row">
            <div className="flex flex-col justify-center items-center w-[140px] gap-2 ml-40">
              <h2 className="text-white font-bold uppercase">Follow Us</h2>
            ...
            <div className="flex flex-col justify-center items-center w-[300px] gap-2 ml-20">
              <h2 className="text-white font-bold uppercase">Others</h2>
              <Link href="https://sosc.org.in/" className="underline">
                Website
              </Link>
              <Link
        ...
        <div className="flex items-center justify-center">
          <span className="text-sm">SOSC © 2025 All Rights Reserved.</span>
        </div>
      </div>
    </>
  );
