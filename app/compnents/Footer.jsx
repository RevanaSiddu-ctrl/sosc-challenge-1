...
export default function Footer(){
    return(
        <>
            <div className="bg-[oklch(77.034%_0.20078_152.412)] w-full min-h-[400px] flex flex-col md:flex-row mt-10 py-8 px-5">
        
                <div className="flex flex-col md:flex-row w-full gap-8 md:gap-0">

                    <div className="flex flex-col justify-center gap-2 md:ml-10 md:w-[40%]">
                    ...
                    <div className="flex flex-col justify-center items-start md:items-center gap-2 md:ml-20 md:w-[20%]">
