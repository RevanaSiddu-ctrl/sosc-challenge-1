...
export default function Footer(){
    return(
        <>
            <div className="bg-[oklch(77.034%_0.20078_152.412)] w-full h-fit flex flex-col mt-10">
        
                <div className=" flex  flex-col md:flex-row gap-8 md:gap-16 mt-10 px-5 md:px-10 pb-8">

                    <div className="flex-1 flex flex-col justify-start  gap-2 mt-2 w-full px-5">
                        <h2 className="text-white /90 text-sm ">Sahyadri Open Source Community</h2>
                        <h4 className="text-white">Sahyadri College of Engineering and Management, Adyar, Mangalore - 575007 IN</h4>
                        <Link href="https://sosc.org.in" className="underline text-white/90 text-sm">sosc.org.in</Link>
                    </div>
                    <div className="flex flex-row md:mt-0 mt-10 ">
                    <div className="flex flex-col justify-center items-center w-[140px] gap-2 ">
                    ...
                    <div className="flex flex-col justify-center items-center md:w-[130px] gap-4 md:ml-20">
