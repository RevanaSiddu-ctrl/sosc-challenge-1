...
// Here the issue was when we click on blogs redirect to events page instead of blogs page, so I have changed the onClick function of blogs button to redirect to ./blogs instead of ./events
  return(
        <>
