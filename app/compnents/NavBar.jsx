...
export default function NavBar() {
  ...
  return(
        <>
            <div className="h-[55px] bg-[oklch(77.034%_0.20078_152.412)] w-full flex flex-row justify-between items-center fixed top-0 left-0 z-50 ">
                  ...
                  <div className="ml-[400px] flex  flex-row gap-10">
