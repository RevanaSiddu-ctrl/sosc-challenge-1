...
export default function NavBar() {
  ...
  return(
        <>
            <div className="h-[90px] bg-[oklch(77.034%_0.20078_152.412)] w-full flex flex-row fixed  items-center  justify-between px-5 md:px-10 top-0 left-0 z-50">
                  <Image src="https://sosc.org.in/_astro/sosc_logo_white.Bej07WYV_Z10hDC0.svg" alt="logo" height={0} width={0}
                    className="h-[50px] w-[50px] md:h-[70px] md-[70px]"/>
                   <div className="ml-[1000px] flex  flex-row gap-3 md:gap-10">
