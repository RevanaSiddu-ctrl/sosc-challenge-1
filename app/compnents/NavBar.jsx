...
export default function NavBar() {
  ...
  return(
        <>
            <div className="fixed h-[90px] bg-[oklch(77.034%_0.20078_152.412)] w-full flex flex-row justify-between items-center top-0 left-0 right-0 z-50">
                ...
                <div className="flex flex-row gap-10 right-0 mr-[100px]">
