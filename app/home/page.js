...
<>
    ...
    <div className="flex flex-col justify-center items-start w-full max-w-[700px] min-h-[500px] md:h-[700px] px-5 md:px-10 mx-auto mt-[90px]">
            ...
            width={80}
             height={80}
            className="mb-3 md:w-[100px] md:h-[100px]"
            />
            ...
            <button className="bg-[oklch(77.034%_0.20078_152.412)] w-[160px] h-[40px] rounded-3xl text-white text-sm font-bold mt-3 cursor-pointer hover:opacity-90">Community Guidelines</button>

    </div>
    <div className="min-h-[400px] md:h-[500px] w-full flex flex-col md:flex-row items-center justify-center gap-5 md:gap-10 px-5 md:px-[10%] py-10">
        <img src="https://sosc.org.in/_astro/hero_github.CjpTNEJ9_lPP1X.webp" alt="img1" className="w-full max-w-[300px] md:max-w-[500px] h-auto" />
    ...
    <div className="min-h-[400px] md:h-[500px] w-full flex flex-col md:flex-row-reverse items-center justify-center gap-5 md:gap-10 px-5 md:px-[10%] py-10">
        <img src="https://sosc.org.in/_astro/hero_clubs.DTTDV-jy_1p64vp.webp" alt="img2" className="w-full max-w-[300px] md:max-w-[500px] h-auto" />
        <div className="flex flex-col items-start gap-3 max-w-[600px]">
    ...
    <div className="min-h-[400px] md:h-[500px] w-full flex flex-col md:flex-row items-center justify-center gap-5 md:gap-10 px-5 md:px-[10%] py-10">
        <img src="https://sosc.org.in/_astro/hero_connect.CV53XNoK_Z2hOGEd.webp" alt="img3" className="w-full max-w-[300px] md:max-w-[500px] h-auto" />
        <div className="flex flex-col items-start gap-3 max-w-[600px]">
            ...
            <button className="bg-[oklch(77.034%_0.20078_152.412)] w-[160px] h-[40px] rounded-3xl text-white text-sm font-bold mt-3 cursor-pointer hover:opacity-90">Learn More</button>
        </div>
    </div> 
