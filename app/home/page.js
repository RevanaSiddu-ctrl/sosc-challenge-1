...
<>
    ...
    <div className="flex flex-col justify-center items-start w-full md:w-[700px] min-h-[500px] md:h-[700px] px-5 md:px-10 md:ml-20 mt-[90px]">
            ...
            <button className="bg-[oklch(77.034%_0.20078_152.412)] w-[160px] h-[40px] rounded-3xl text-white text-xs md:text-sm font-bold mt-3 cursor-pointer">Community Guidelines</button>

    </div>
    <div className="min-h-[400px] md:h-[500px] w-full flex flex-col md:flex-row items-center px-5 md:pl-[15%] gap-5 md:gap-0">
    ...
    <div className="min-h-[400px] md:h-[500px] w-full flex flex-col md:flex-row items-center px-5 md:pl-[15%] gap-5 md:gap-0">
        ...
        <div className="flex flex-col items-start gap-3">
            ...
            <button className="bg-[oklch(77.034%_0.20078_152.412)] w-[160px] h-[40px] rounded-3xl text-white text-xs md:text-sm font-bold mt-3 cursor-pointer">Learn More</button>
        </div>
    </div> 
