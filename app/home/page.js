...
export default function Home() {
  return (
    ...
    <div className="overflow-x-hidden">
      ...
      <div className="flex flex-col justify-center mt-50 md:mt-0 items-start w-auto md:w-[700px] h-auto md:h-[700px] ml-5 md:ml-10  md:ml-120 mt-10 md:mt-0">
        <Image
      ...
      <div className=" h-auto md:h-[500px] w-full mt-50 md:mt-0 flex flex-col-reverse md:flex-row items-center mt-10 md:mt-0  pl-5 md:pl-[15%] ">
        <img
      ...
      <div className="h-auto md:h-[500px] w-full flex flex-col md:flex-row mt-20 md:mt-0 items-center pl-5 md:pl-[15%] ">
        <div className="flex flex-col items-start gap-3">
          <h2 className="text-black font-bold text-2xl">
      ...
      <div className="h-auto md:h-[500px] w-full flex flex-col-reverse md:flex-row items-center pl-5 mt-20 md:mt-0 md:pl-[15%] ">
        <img
          ...
          height={500}
        />
        <div className="flex flex-col items-start gap-3 mt-15 md:mt-0 ">
