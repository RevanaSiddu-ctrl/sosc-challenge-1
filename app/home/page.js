...
<>
    ...
    <div className="h-[500px] w-full flex flex-row items-center justify-center px-50">
        <img src="https://sosc.org.in/_astro/hero_github.CjpTNEJ9_lPP1X.webp" alt="img1" width={600} height={600} />
        <div className="flex flex-col items-start gap-3">
            <h2 className="text-black font-bold text-3xl">Get Trained by Experts</h2>
            <p className="text-md font-light text-black/50  w-max-[600px]">
    ...
    <div className="h-[500px] w-full flex flex-row items-center justify-center px-50">
        <div className="flex flex-col items-start gap-3">
            <h2 className="text-black font-bold text-3xl">Explore clubs and Activities</h2>
            <p className="text-md font-light text-black/50 w-max-[600px]">
    ...
    <div className="h-[500px] w-full flex flex-row items-center justify-center px-50">
        ...
        <div className="flex flex-col items-start gap-3">
            <h2 className="text-black font-bold text-3xl">Get Connected !</h2>
            <p className="text-ml font-light text-black/50 w-max-[600px]">
