...
<>
    ...
    <div className="flex flex-col justify-center items-start w-full md:w-[700px] h-auto md:h-[700px] px-5 md:px-10 md:ml-20">
            ...
            <button className="bg-[oklch(77.034%_0.20078_152.412)] w-[140px] md:w-[160px] h-[40px] rounded-3xl text-white text-xs md:text-sm font-bold mt-3 cursor-pointer">Community Guidelines</button>
