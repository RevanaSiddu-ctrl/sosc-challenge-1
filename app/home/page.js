...
<>
    ...
    <div className="flex flex-col justify-center items-start w-full md:w-[700px] h-auto md:h-[700px] px-5 md:px-10 py-10 md:ml-20">
            ...
            width={100}
             height={100}
            className="mb-3 w-[80px] h-[80px] md:w-[100px] md:h-[100px]"
            />
    ...
    <div className="min-h-[400px] md:h-[500px] w-full flex flex-col md:flex-row items-center px-5 md:pl-[15%] py-10 gap-5">
