...
<>
    ...
    <div className="flex flex-col justify-center  items-start w-full md:w-[700px] h-auto md:h-[700px] px-5 md:px-10 md:ml-20">
            ...
            <button className="bg-[oklch(77.034%_0.20078_152.412)] w-[140px] md:w-[160px] h-[40px] rounded-3xl text-white text-sm font-bold mt-3 cursor-pointer">Community Guidelines</button>

    </div>
    <div className="h-auto md:h-[500px] w-full flex flex-col md:flex-row items-center px-5 md:pl-[15%] py-10 ">
        <img src="https://sosc.org.in/_astro/hero_github.CjpTNEJ9_lPP1X.webp" alt="img1" className="w-full md:w-[500px] h-auto" />
        <div className="flex flex-col items-start gap-3 mt-5 md:mt-0">
            <h2 className="text-black font-bold text-xl md:text-2xl">Get Trained by Experts</h2>
            <p className="text-sm md:text-md font-light text-black w-full md:w-[600px]">
    ...
    <div className="h-auto md:h-[500px] w-full flex flex-col md:flex-row items-center px-5 md:pl-[15%] py-10 ">
        <div className="flex flex-col items-start gap-3 order-2 md:order-1 mt-5 md:mt-0">
        ...
        <img src="	https://sosc.org.in/_astro/hero_clubs.DTTDV-jy_1p64vp.webp" alt="img2" className="w-full md:w-[500px] h-auto order-1 md:order-2"/>
    </div> 
    <div className="h-auto md:h-[500px] w-full flex flex-col md:flex-row items-center px-5 pl-[15%] py-10 ">
        <img src="https://sosc.org.in/_astro/hero_connect.CV53XNoK_Z2hOGEd.webp" alt="img3" className="w-full md:w-[500px] h-auto" />
        <div className="flex flex-col items-start gap-3 mt-5 md:mt-0">
            <h2 className="text-black font-bold text-xl md:text-2xl">Get Connected</h2>
            <p className="text-sm mdtext-md font-light text-black w-full md:w-[600px]">
