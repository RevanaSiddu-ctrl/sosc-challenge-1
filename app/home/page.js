    ...
    <>
      ...
      <div className="flex flex-col justify-center items-start w-[700px] h-[700px] px-10 ml-120">
        <Image 
          ...
          className="mb-3"
        />
        <h2 className="text-black text-2xl font-baloo font-bold mb-4">
          Sahyadri Open Source Community
        </h2>
        <p className="text-gray-700 text-md max-w-[700px] leading-relaxed font-baloo">
        ...
        <button className="bg-[oklch(77.034%_0.20078_152.412)] w-[160px] h-[40px] rounded-3xl text-white text-sm font-baloo font-bold mt-3 cursor-pointer">
      ...
      <div className="h-[500px] w-full flex flex-row items-center pl-[15%]">
        ...
        <div className="flex flex-col items-start gap-3">
          <h2 className="text-black text-2xl font-baloo font-bold">Get Trained by Experts</h2>
          <p className="text-gray-700 text-md max-w-[700px] leading-relaxed font-baloo">
      ...
      <div className="h-[500px] w-full flex flex-row items-center pl-[15%]">
        <div className="flex flex-col items-start gap-3">
          <h2 className="text-black text-2xl font-baloo font-bold">Explore clubs and Activities</h2>
          <p className="text-gray-700 text-md max-w-[700px] leading-relaxed font-baloo">
        ...
        <img src="https://sosc.org.in/_astro/hero_clubs.DTTDV-jy_1p64vp.webp" alt="img2" width={600} height={600} />
      </div>

      <div className="h-[500px] w-full flex flex-row items-center pl-[15%]">
        <img src="https://sosc.org.in/_astro/hero_connect.CV53XNoK_Z2hOGEd.webp" alt="img3" width={600} height={600} />
        <div className="flex flex-col items-start gap-3">
          <h2 className="text-black text-2xl font-baloo font-bold">Get Connected</h2>
          <p className="text-gray-700 text-md max-w-[700px] leading-relaxed font-baloo">
