...
<>
    ...
    <div className="flex flex-col justify-center items-start w-full md:w-[700px] h-auto md:h-[700px] px-5 md:px-10 py-10">
    ...
    <div className="h-auto md:h-[500px] w-full flex flex-col md:flex-row items-center px-5 md:pl-[15%] py-10 md:py-0 gap-5">
    ...
    <div className="h-auto md:h-[500px] w-full flex flex-col-reverse md:flex-row items-center px-5 md:pl-[15%] py-10 md:py-0 gap-5">
        <div className="flex flex-col items-start gap-3">
        ...
        <img src="https://sosc.org.in/_astro/hero_clubs.DTTDV-jy_1p64vp.webp" alt="img2" className="w-full md:w-[500px] h-auto" />
    </div> 
    <div className="h-auto md:h-[500px] w-full flex flex-col md:flex-row items-center px-5 md:pl-[15%] py-10 md:py-0 gap-5">
