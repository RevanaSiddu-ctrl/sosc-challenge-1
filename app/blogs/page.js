...
export default function Blogs() {
  return (
    <>
      ...
      <div className="w-full md:h-[400px] relative mt-[90px] overflow-x-hidden">
        <Image
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          <h1 className="text-white text-2xl md:font-extrabold ml-6 md:ml-0">
     ...
     <div className="flex justify-center items-center mt-10">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-20 mt-10  md:px-10  justify-center items-center">
