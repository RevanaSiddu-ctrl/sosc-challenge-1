...
export default function Footer(){
    return(
        <>
            <div className="bg-[oklch(77.034%_0.20078_152.412)] w-full min-h-[400px] flex flex-col md:flex-row mt-10 py-10 px-5">
        
                    <div className="flex flex-col justify-center gap-2 w-full md:w-[40%] mb-8 md:mb-0">
                    ...
                    <div className="flex flex-col justify-center items-start md:items-center gap-2 w-full md:w-[30%] mb-8 md:mb-0">
                    ...
                    <div className="flex flex-col justify-center items-start md:items-center gap-2 w-full md:w-[30%]">
