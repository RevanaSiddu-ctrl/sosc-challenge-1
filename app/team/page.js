...
export default function Team(){
    return(
        ...
        <NavBar/><div className="w-full h-[250px] md:h-[400px] relative mt-[90px] overflow-x-hidden">
              ...
              <div className="w-full h-auto flex flex-col items-start pt-5 md:pl-10 px-10">
                ...
                <div className="flex justify-center items-center mt-10 w-full">
                      <div className="grid grid-cols-2 md:grid-cols-2 grid-cols-2 md:gap-5 mt-10 px-4 md:px-10  justify-center items-center">
                        {teamData.map((data) => (
                          <CardC
                            key={data.id}
                            image={data.image}
