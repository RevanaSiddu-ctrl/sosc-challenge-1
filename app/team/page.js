...
export default function Team(){
    return(
        <>
        <NavBar/><div className="w-full h-[300px] md:h-[400px] relative mt-[90px] overflow-x-hidden">
                <Image
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center px-5">
                  ...
                  <h1 className="text-white text-sm md:text-2xl font-extrabold text-center">
                    Meet the passionate individuals driving our community forward
                  </h1>
                </div>
              </div>

              <div className="w-full h-auto flex flex-col items-center md:items-start pt-10 px-5 md:pl-30">
                ...
                <div className="flex justify-center items-center mt-10">
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-20 mt-10 px-5 md:px-10 justify-center items-center">
                        {teamData.map((data) => (
                          <CardC
                            key={data.id}
                            image={data.image}
