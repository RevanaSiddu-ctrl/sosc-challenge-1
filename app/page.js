...
export default function Home() {
  return (
    <>
      ...
      <div className="flex flex-col justify-center items-start w-full max-w-4xl px-6 md:px-10 mx-auto min-h-[80vh] pt-20 md:pt-0">
        <Image
        ...
        <p className="text-gray-700 text-md md:text-lg max-w-full md:max-w-[700px] leading-relaxed">
        ...
        <button className="bg-[oklch(77.034%_0.20078_152.412)] w-[180px] h-[45px] rounded-3xl text-white text-sm font-bold mt-5 cursor-pointer hover:opacity-90 transition">
          Community Guidelines
        </button>
      </div>

    
      <div className="w-full py-10 px-6 md:px-20 flex flex-col md:flex-row items-center gap-10">
        <img
        ...
        <div className="flex flex-col items-start gap-3">
          ...
          <p className="text-md font-light text-black w-full md:w-[600px]">
            ...
            workshops and trainings led by speakers from other technical
      ...
      <div className="w-full py-10 px-6 md:px-20 flex flex-col-reverse md:flex-row items-center gap-10">
        <div className="flex flex-col items-start gap-3">
          <h2 className="text-black font-bold text-2xl md:text-3xl">
