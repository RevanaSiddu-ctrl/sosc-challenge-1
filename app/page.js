...
<>
    ...
    <div className="font-[poppins] space-y-7">
        <div className="flex flex-col justify-center  items-start w-[800px] h-[700px] px-10 ml-120 ">
            ...
            <p className="text-gray-600 text-md max-w-[700px] leading-relaxed">
            ...
            <button className="bg-[oklch(77.034%_0.20078_152.412)] w-50 h-10 rounded-3xl text-gray-100 text-sm mt-3 cursor-pointer p-2 ">Community Guidilnes</button>
    ...
    <div className="h-[500px] w-full flex flex-row items-center pl-[15%] ">
        ...
        <div className="flex flex-col items-start gap-3">
            <h2 className="text-black font-semibold text-3xl">Get Trained by Experts</h2>
            <p className="text-md font-light text-gray-600 w-[600px]">
    ...
    <div className="h-[500px] w-full flex flex-row items-center pl-[15%] ">
        <div className="flex flex-col items-start gap-3">
            <h2 className="text-black font-semibold text-3xl">Explore clubs and Activities</h2>
            <p className="text-md font-light text-gray-600 w-[600px]">
    ...
    <div className="h-[500px] w-full flex flex-row items-center pl-[15%] ">
        ...
        <div className="flex flex-col items-start gap-3">
            <h2 className="text-black font-semibold text-3xl">Get Connected</h2>
            <p className="text-md font-light text-gray-600 w-[600px]">
