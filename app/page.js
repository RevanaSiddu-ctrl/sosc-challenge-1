...
export default function Home() {
  return (
    <>
      ...
      <div className="flex flex-col justify-center items-start w-full max-w-[700px] h-auto px-6 md:px-10 mt-10 md:ml-32">
        <Image
      ...
      <div className="w-full flex flex-col md:flex-row items-center px-6 md:pl-[15%] py-10 gap-6">
        <img
